    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-8">
          <h1 className="text-3xl font-bold mb-6 text-foreground">Expenses</h1>
                ...
                <table className="min-w-full divide-y divide-gray-700">
                  ...
                  <tbody className="divide-y divide-gray-700">
                    {expenses.sort((a, b) => new Date(b.date) - new Date(a.date)).map((expense) => (
                      <tr key={expense.id} className="bg-primary">
                        <td className="px-6 py-4 whitespace-nowrap text-foreground">{expense.expenseType}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-foreground">${expense.amount}</td>
                        <td className="px-6 py-4 whitespace-nowrap text-foreground">{expense.date}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
